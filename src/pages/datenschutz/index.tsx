    ...
    return (
        <main className="flex w-full items-center justify-center py-10">
            <section className={'w-[340px] md:w-[1000px]'}>
                ...
                <h2 className={'font-bold text-blue-500'}>2. Hosting</h2>
                ...
                <h2 className={'font-bold text-blue-500'}>3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                <h3>Datenschutz</h3>{' '}
                <p>
                ...
                <p>
                    ...
                    <br />
                    Rote Stra&szlig;e 15
                    <br />
                    24937 Flensburg
                </p>
                <p>
                    Telefon: +49 (0) 461-48087676
                    <br />
                    E-Mail: flensburger-bowlingcenter@t-online.de
                </p>
                <p>
                ...
                <h2 className={'font-bold text-blue-500'}>4. Datenerfassung auf dieser Website</h2>
